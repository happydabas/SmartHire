...
export function JobPublishedEmail({ userName, jobTitle, companyName, publishDate, actionUrl }) {
  const displayUserName = userName || '{{userName}}';
  const displayJobTitle = jobTitle || '{{jobTitle}}';
  const displayCompanyName = companyName || '{{companyName}}';
  const displayDate = publishDate || '{{publishDate}}';
  ...
  return (
    <BaseEmail>
      ...
      <p style={{
        ...
        Hi {displayUserName}, your new job listing has been published and is now visible to candidates.
      </p>
      ...
      <div style={{
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style={{ borderCollapse: 'collapse' }}>
          <tbody>
            ...
            <tr>
              <td style={{ padding: '0 0 8px 0', fontSize: '11px', color: '#64748b', fontWeight: 'bold' }}>PUBLISH DATE</td>
            </tr>
            <tr>
      ...
      <p style={{
        ...
        You can view candidate applications, update pipeline stages, and manage the listing directly from the recruiter dashboard.
      </p>

      <PrimaryButton text="Manage Job" url={displayUrl} />
...
export default JobPublishedEmail;
