...
export function ResumeAnalysisLoader({ step }) {
  const steps = [
    { id: 1, label: 'Analyzing Resume...' },
    { id: 2, label: 'Checking ATS Compatibility...' },
    { id: 3, label: 'Generating Suggestions...' }
  ];
  ...
  return (
    <div className="bg-white border border-slate-100 rounded-3xl p-6 md:p-8 shadow-sm dark:bg-slate-900 dark:border-slate-800 space-y-6 max-w-md mx-auto" aria-live="polite">
      <div className="space-y-1.5 text-center">
        <h4 className="text-sm font-extrabold text-slate-800 dark:text-white">
          Analyzing Resume Quality
        </h4>
        <p className="text-xs text-slate-450 font-bold dark:text-slate-500">
          Evaluating structures, keyterms density, and passing ratios.
        </p>
      </div>
