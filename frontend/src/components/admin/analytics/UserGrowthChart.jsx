...
export function UserGrowthChart({ data = [] }) {
  return (
    <div className="bg-white border border-slate-100 rounded-3xl p-6 shadow-sm dark:bg-slate-900 dark:border-slate-800 space-y-4">
      <div>
        <h3 className="text-sm font-extrabold text-slate-800 uppercase tracking-wider dark:text-white" id="user-growth-chart-title">
          User Growth Rate
        </h3>
        <p className="text-xs text-slate-400 font-semibold dark:text-slate-500">
          Monthly user registration trends over time
        </p>
      </div>

      <div className="h-72 w-full" aria-describedby="user-growth-chart-title">
