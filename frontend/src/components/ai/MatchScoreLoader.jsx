...
export function MatchScoreLoader({ step }) {
  const steps = [
    { id: 1, label: 'Calculating Match...' },
    { id: 2, label: 'Comparing Skills...' },
    { id: 3, label: 'Generating Recommendations...' }
  ];
    ...
    <div className="bg-white border border-slate-100 rounded-3xl p-6 md:p-8 shadow-sm dark:bg-slate-900 dark:border-slate-800 space-y-6 max-w-md mx-auto animate-fadeIn" role="status" aria-live="polite">
      <div className="space-y-1.5 text-center">
        <h4 className="text-sm font-extrabold text-slate-800 dark:text-white">
          Computing AI Match Score
        </h4>
        <p className="text-xs text-slate-450 font-bold dark:text-slate-500">
          We are analyzing candidate profiles against posting parameters.
        </p>
      </div>
...
export default MatchScoreLoader;
